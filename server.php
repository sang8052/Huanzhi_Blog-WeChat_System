...
//2.新增人脸识别系统重置脚本
  ...
  class WechatAPI 
  {
     ...
     public function ResponseMsg()
    {
       $postStr = $GLOBALS["HTTP_RAW_POST_DATA"];
        if (!empty($postStr))
        {
            ...
            {
            	//echo "接收到post数据包";
            	$res->ResponseData=$res->Echo_Version($keyword,$res->ResponseData);//检查关键字是否为 版本信息||系统版本，如果是则输出相应信息
   ...
   class Response
   {
    ...
    public function Echo_Version($keyword,$ResponseData)//输出版本信息
     {
